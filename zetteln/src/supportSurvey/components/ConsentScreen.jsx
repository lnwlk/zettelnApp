  ...
  return (
    <div className="rounded-2xl md:p-8">
      ...
      <div className="rounded-xl bg-white p-4 text-center">
        <h2 className="mb-3 text-xl text-slate-900">{t('supportSurvey.consent.title')}</h2>
        <p className="mb-6 leading-relaxed text-slate-700">{t('supportSurvey.consent.text')}</p>
